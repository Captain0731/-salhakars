...
export default function IPCBNSMapping() {
  ...
  const handleSearch = async (offset = 0) => {
    ...
    try {
      ...
      setError(err.message || "Failed to fetch IPC-BNS mappings");
      setMappings([]);
      setPagination(null);
    } finally {
      setLoading(false);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg mb-2" style={{ color: '#8C969F', fontFamily: 'Roboto, sans-serif' }}>
              Comprehensive mapping between Indian Penal Code (IPC) and Bharatiya Nyaya Sanhita (BNS)
            </p>
            <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium" 
              ...
              Currently viewing: IPC ↔ BNS (Criminal Law)
            </div>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                      ...
                      <div className="bg-red-50 p-4 rounded-lg">
                        <div className="text-center">
                          <div className="text-sm font-medium text-gray-600 mb-1">IPC Section</div>
                          <div className="text-2xl font-bold text-red-600 mb-2">{mapping.ipc_section}</div>
                        </div>
                      </div>
                      ...
                      <div className="bg-green-50 p-4 rounded-lg">
                        <div className="text-center">
                          <div className="text-sm font-medium text-gray-600 mb-1">BNS Section</div>
                          <div className="text-2xl font-bold text-green-600 mb-2">{mapping.bns_section}</div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-red-50 p-6 rounded-lg">
                  <h3 className="font-semibold mb-4 text-lg" style={{ color: '#1E65AD' }}>IPC Section</h3>
                  <div className="text-center mb-4">
                    <div className="text-4xl font-bold text-red-600 mb-2">{selectedMapping.ipc_section}</div>
                  </div>
                  <div className="text-sm text-gray-600">
                    <strong>Act:</strong> Indian Penal Code, 1860
                  </div>
                </div>
                <div className="bg-green-50 p-6 rounded-lg">
                  <h3 className="font-semibold mb-4 text-lg" style={{ color: '#1E65AD' }}>BNS Section</h3>
                  <div className="text-center mb-4">
                    <div className="text-4xl font-bold text-green-600 mb-2">{selectedMapping.bns_section}</div>
                  </div>
                  <div className="text-sm text-gray-600">
                    <strong>Act:</strong> Bharatiya Nyaya Sanhita, 2023
                  </div>
                </div>
              </div>
